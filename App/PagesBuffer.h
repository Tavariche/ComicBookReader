        ...
        public QObject
{
    ...
    public:
        ...
        //  Descr:  Accès aux pages depuis un entier. Permet l'itération par boucle.
        ...
        int getNumberOfPages(int index = 0){return m_pagesData[m_indexToRole[index]].numberOfPages;}
        double getPagesRatio(int index = 0){return m_pagesData[m_indexToRole[index]].pagesRatio;}
